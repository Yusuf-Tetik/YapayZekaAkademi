...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (data.email === 'demo@mindsense.com' && data.password === 'demo123') {
        // Başarılı öğrenci girişi - dashboard'a yönlendir
        console.log('Öğrenci girişi başarılı:', data)
        navigate('/dashboard')
      } else if (data.email === 'teacher@mindsense.com' && data.password === 'teacher123') {
        // Başarılı öğretmen girişi - teacher dashboard'a yönlendir
        console.log('Öğretmen girişi başarılı:', data)
  ...
  // Öğretmen girişi için hızlı giriş
    ...
    <div className="login-container">
      ...
      <form className="login-form" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="login-demo">
          <p className="demo-title">🎯 Öğrenci Demo Girişi:</p>
        ...
        {/* Öğretmen Demo Girişi */}
        <div className="teacher-demo">
          <p className="demo-title">👩‍🏫 Öğretmen Demo Girişi:</p>
          <p className="demo-info">
            E-mail: <strong>teacher@mindsense.com</strong><br />
            Şifre: <strong>teacher123</strong>
          </p>
          <Button
            type="button"
            variant="secondary"
